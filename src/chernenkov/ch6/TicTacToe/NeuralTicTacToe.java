 ...
 */
package chernenkov.ch6.TicTacToe;

import java.io.IOException;
import java.util.Date;
import java.util.concurrent.Executors;

import chernenkov.ch6.TicTacToe.game.Game;
import chernenkov.ch6.TicTacToe.game.ScorePlayer;
import chernenkov.ch6.TicTacToe.players.Player;
import chernenkov.ch6.TicTacToe.players.PlayerBoring;
import chernenkov.ch6.TicTacToe.players.PlayerHuman;
import chernenkov.ch6.TicTacToe.players.PlayerLogic;
import chernenkov.ch6.TicTacToe.players.PlayerRandom;
import chernenkov.ch6.TicTacToe.players.minmax.PlayerMinMax;
import chernenkov.ch6.TicTacToe.players.neural.PlayerNeural;
import chernenkov.ch6.TicTacToe.players.neural.TicTacToeGenetic;
import chernenkov.neural.feedforward.FeedforwardLayer;
import chernenkov.neural.feedforward.FeedforwardNetwork;
import chernenkov.neural.util.SerializeObject;
